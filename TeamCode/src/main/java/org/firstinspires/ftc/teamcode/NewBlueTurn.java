...
////        //1 - LEFT, 2 - RIGHT, 3 - CENTER, 0 - NOT VISIBLE, 4 - TIMEOUT
        if (targetPosition == 1) {
            ...
            while(opModeIsActive()){
                telemetry.update();
                if (robot.angles.firstAngle > -84) { //> -20
                    robot.left1.setPower(-0.05); //ppnn
                    robot.left2.setPower(-0.05);
                    robot.right1.setPower(0.05);
                    robot.right2.setPower(0.05);
                    telemetry.update();
                }else if(robot.angles.firstAngle < -96){ //< -30
                    ...
                    while(opModeIsActive()){
                        telemetry.update();
                        if (robot.angles.firstAngle > -40) { //> -20
                            robot.left1.setPower(-0.05); //ppnn
                            robot.left2.setPower(-0.05);
                            robot.right1.setPower(0.05);
                            robot.right2.setPower(0.05);
                            telemetry.update();
                        }else if(robot.angles.firstAngle < -50){ //< -30
                            robot.left1.setPower(0.05); //nnpp
                            robot.left2.setPower(0.05);
                            robot.right1.setPower(-0.05);
                            robot.right2.setPower(-0.05);
                            ...
                            sleep(500);
                            telemetry.update();
                            robot.driveForwardSetDistance(0.1, 350);
                            sleep(500);
                            robot.clawBottom.setPosition(robot.BLOCK_CLAW_CLOSED_BOTTOM);
                            sleep(500);
                            robot.driveForwardSetDistance(0.1,50);
