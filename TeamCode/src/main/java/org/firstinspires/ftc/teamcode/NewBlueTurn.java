...
/**
 * Created by salty on 12/30/2017.
 */
...
public class NewBlueTurn extends LinearOpMode{
    ...
    public final static int SHOULDER_POS1 = 40;
    public final static int SHOULDER_POS2 = 36;
    public final static int SHOULDER_POS3 = 32;

    public final static int TURN1 = 2000;
    public final static int TURN2 = 2200;
    public final static int TURN3 = 2400;
    ...
    public void runOpMode(){
        ...
        if (targetPosition == 1){
            ...
            sleep(5000);
            robot.turnDirection(0.2, TURN1, "CW");
            sleep(5000);
